...
const equalButton = document.querySelector('[data-equals-operand]')
const deleteButton = document.querySelector('[data-delete-operand]')
const allclearButton = document.querySelector('[data-all-clear-operand]')
